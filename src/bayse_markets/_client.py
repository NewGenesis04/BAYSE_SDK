...
class BayseClient:
    ...
    async def list_sports_leagues(
        self,
        *,
        trace_id: str | None = None,
    ) -> BayseResponse[Any]:
        """GET /v1/pm/sports/leagues — list sports leagues."""
        return await self._request(
            "GET",
    ...
    async def list_sports_teams(
        ...
        *,
        ...
        """GET /v1/pm/sports/teams — list sports teams."""
        return await self._request(
            "GET",
            "/v1/pm/sports/teams",
            auth_level="public",
    ...
    async def list_sports_games(
        self,
        *,
        params: dict[str, Any] | None = None,
        trace_id: str | None = None,
    ) -> BayseResponse[Any]:
        """GET /v1/pm/sports/games — list sports games."""
        return await self._request(
            "GET",
            "/v1/pm/sports/games",
            params=params,
    ...
    async def list_liquidity_rewards(
        self,
        *,
        page: int = 1,
        size: int = 20,
        ...
        """GET /v1/pm/liquidity-rewards — paginated history of epoch payouts."""
        return await self._request(
            "GET",
    ...
    async def get_active_liquidity_rewards(
        self,
        *,
        trace_id: str | None = None,
    ) -> BayseResponse[Any]:
        """GET /v1/pm/liquidity-rewards/active — in-progress accumulation."""
        return await self._request(
            "GET",
